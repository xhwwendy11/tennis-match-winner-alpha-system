...
import { buildExecutionShortlist } from '../foundation/executionShortlist.js'
...
export async function main(argv = process.argv): Promise<void> {
  ...
  const report = await buildExecutionShortlist(rootDir, { includeWatchOnly, includeBlocked, limit: limit ?? undefined })
